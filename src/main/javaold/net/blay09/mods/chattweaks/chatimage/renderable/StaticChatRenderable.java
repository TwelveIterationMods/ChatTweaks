...
public class StaticChatRenderable implements IChatRenderable {
	...
	protected void calculateScale() {
		...
		final float maxHeight = ChatTweaksConfig.CLIENT.smallerEmotes.get() ? MAX_HEIGHT_SMALL : MAX_HEIGHT;
    ...
    public int getWidthInSpaces() {
        ...
        return Math.max(minWidthInSpaces, (int) Math.ceil((width * scale) / (float) Minecraft.getInstance().fontRenderer.getCharWidth(' ')));
    }
