...
public class  GuiButtonDeleteChannelConfirm extends GuiButton {
	...
	public GuiButtonDeleteChannelConfirm(int buttonId, int x, int y, FontRenderer fontRenderer) {
		super(buttonId, x, y, fontRenderer.getStringWidth(I18n.format("gui.button.deleteConfirm")), fontRenderer.FONT_HEIGHT, TextFormatting.UNDERLINE + I18n.format("gui.button.deleteConfirm"));
	}
