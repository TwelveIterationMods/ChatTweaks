...
//import net.blay09.mods.chattweaks.gui.widget.FormattedTextFieldWidget;
...
//import net.blay09.mods.chattweaks.gui.formatter.FormatStringFormatter;
//import net.blay09.mods.chattweaks.gui.formatter.RegExStringFormatter;
...
//
//	public GuiChatView(@Nullable Screen parentScreen, ChatView chatView) {
...
//
//		private final FormattedTextFieldWidget textField;
...
//
//			textField = new FormattedTextFieldWidget(10, new FormattedFontRenderer(mc, mc.fontRenderer, formatter), owningEntryList.controlX + 1, 0, owningEntryList.controlWidth - 3, 16);
