package net.blay09.mods.chattweaks.chatimage;

import com.mojang.blaze3d.systems.RenderSystem;
import net.blay09.mods.chattweaks.chatimage.renderable.IAnimatedChatRenderable;
...
public class ChatImageDefault extends ChatImage {
    ...
    public void draw(int x, int y, int alpha) {
        ...
        RenderSystem.color4f(1f, 1f, 1f, (float) alpha / 255f);
        RenderSystem.translatef(x, y, 100f);
        if (image instanceof IAnimatedChatRenderable) {
            ((IAnimatedChatRenderable) image).updateAnimation();
        }
        // TODO AbstractGui.blit(0, 0, image.getTexCoordX(), image.getTexCoordY(), image.getWidth(), image.getHeight(), image.getSheetWidth(), image.getSheetHeight());
