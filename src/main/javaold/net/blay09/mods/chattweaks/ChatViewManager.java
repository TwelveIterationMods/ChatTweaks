...
public class ChatViewManager {
    ...
    public static void load() {
        removeAllChatViews();
        Gson gson = new Gson();
        try (FileReader reader = new FileReader(new File(Minecraft.getInstance().gameDir, "ChatTweaks/views.json"))) {
    ...
    public static void save() {
        Gson gson = new Gson();
        try (FileWriter writer = new FileWriter(new File(Minecraft.getInstance().gameDir, "ChatTweaks/views.json"))) {
    ...
    public static void addChatView(ChatView view) {
        ...
        if (gui instanceof ExtendedChatScreen) {
            ((ExtendedChatScreen) gui).updateChannelButtons();
        }
    }
    ...
    private static final List<String> reservedNames = Lists.newArrayList();
