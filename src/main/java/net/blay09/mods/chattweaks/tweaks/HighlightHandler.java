...
import net.blay09.mods.chattweaks.api.event.ChatMessageEvent;
...
public class HighlightHandler {
    ...
    @SubscribeEvent
    public static void onPrintChatMessage(ChatMessageEvent event) {
        ...
        ITextComponent senderComponent = event.getChatMessage().getSenderComponent();
        ...
        if (sender != null && !sender.isEmpty()) {
            ...
            if (!sender.equals(playerName)) {
                ITextComponent messageComponent = event.getChatMessage().getTextComponent();
