...
//		private final SortChatViewButton buttonUp;
//		private final SortChatViewButton buttonDown;
//
...
//			buttonUp = new SortChatViewButton(1, 0, 0, this, -1);
//			buttonDown = new SortChatViewButton(1, 0, 0, this, 1);
//		}
//
//		@Override
//		public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected, float partial) {
